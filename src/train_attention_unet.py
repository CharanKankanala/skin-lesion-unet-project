"""
Training script for the Attention U-Net.
...
def train_attention_unet(
    ...
    run_tag = f"attention_unet_{loss_name}"
    ...
    # ---- Device ----
    device = get_device()
    print(f"\n[Attention U-Net | {loss_name} | aug={use_augmentation} | "
...
if __name__ == "__main__":
    train_attention_unet(loss_name="dice", num_epochs=10)
